...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//   XmlArrayView - вспомогательный контейнер (вью на массив) для узлов и атрибутов XmlNode
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//--------------------------------------------------------------------------------------------------------------------------------
template<class T> class XmlArrayView
{
public:
...
protected:
	...
	// Выделяет в куче новый блок, добавляет его в список m_Blocks и возвращает указатель
	// на блок. Параметр type задаёт тип, а count - количество элементов в массиве data
