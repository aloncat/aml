...
public:
	...
	// Разрешает или запрещает формирование сообщения. По умолчанию вывод разрешён. NB: иногда для файловых журналов вывод
	...
	// Функция, эквивалентная предыдущей, но с возвращающая строку с заголовком
