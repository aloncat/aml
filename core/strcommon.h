...
protected:
	...
	AML_NOINLINE void MoveTo(ZExStringView& dest) noexcept
	{
		...
		} else
		{
			...
			// Если размер m_Inner кратен 8 байтам, то быстрее копировать весь массив целиком. В
...
{
	// Согласно стандарту, дефолтный конструктор, если он удовлетворяет требованиям constexpr,
